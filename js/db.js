const DB = {
  tables: ["customers", "parts", "materials", "productions", "qcs", "deliveries", "tracking"],
  init() {
...
// DEPRECATED: Method ini tidak digunakan lagi. Diganti oleh findByKode().
  findByTrackingId(trackingId) {
    return this.get("materials").find((m) => m.tracking_id === trackingId);
  },
...
migrate() {
  ...
  seedDemoData() {
    ...
    const materials = [
      { id: 1001, kode: "20240001A", customer_id: 1, part_id: 1, nomor_surat_jalan: "SJ/TOY/2024/00001", lot_no: "LOT-A001", material_charge: "CH001", status_part: "Masspro", qty: 50, berat_part_snapshot: 2.5, berat_total_part: 125, tanggal_masuk: "2024-01-10", keterangan: "Material trial customer", process_type: "", diinput_oleh: "", qr_code: "", status_proses: "Waiting", created_at: "2024-01-10T00:00:00Z", updated_at: "2024-01-10T00:00:00Z" },
      { id: 1002, kode: "20240002A", customer_id: 2, part_id: 3, nomor_surat_jalan: "SJ/HON/2024/00002", lot_no: "LOT-B001", material_charge: "CH002", status_part: "Trial", qty: 120, berat_part_snapshot: 1.8, berat_total_part: 216, tanggal_masuk: "2024-01-11", keterangan: "Part awal proses", process_type: "", diinput_oleh: "", qr_code: "", status_proses: "Process", created_at: "2024-01-11T00:00:00Z", updated_at: "2024-01-11T00:00:00Z" },
      { id: 1003, kode: "20240003A", customer_id: 3, part_id: 5, nomor_surat_jalan: "SJ/YAM/2024/00003", lot_no: "LOT-C001", material_charge: "CH003", status_part: "Part Awal 1", qty: 80, berat_part_snapshot: 4.0, berat_total_part: 320, tanggal_masuk: "2024-01-12", keterangan: "Menunggu jadwal furnace", process_type: "", diinput_oleh: "", qr_code: "", status_proses: "Process", created_at: "2024-01-12T00:00:00Z", updated_at: "2024-01-12T00:00:00Z" },
      { id: 1004, kode: "20240004A", customer_id: 4, part_id: 7, nomor_surat_jalan: "SJ/MIT/2024/00004", lot_no: "LOT-D001", material_charge: "CH004", status_part: "Part Awal 2", qty: 200, berat_part_snapshot: 3.5, berat_total_part: 700, tanggal_masuk: "2024-01-13", keterangan: "", process_type: "", diinput_oleh: "", qr_code: "", status_proses: "Waiting", created_at: "2024-01-13T00:00:00Z", updated_at: "2024-01-13T00:00:00Z" },
      { id: 1005, kode: "20240005A", customer_id: 5, part_id: 8, nomor_surat_jalan: "SJ/SUZ/2024/00005", lot_no: "LOT-E001", material_charge: "CH005", status_part: "Part Awal 3", qty: 150, berat_part_snapshot: 1.2, berat_total_part: 180, tanggal_masuk: "2024-01-14", keterangan: "Catatan incoming", process_type: "", diinput_oleh: "", qr_code: "", status_proses: "Finish", created_at: "2024-01-14T00:00:00Z", updated_at: "2024-01-14T00:00:00Z" },
      { id: 1006, kode: "20260004I", customer_id: 1, part_id: 2, nomor_surat_jalan: "SJ/TOY/2026/00004", lot_no: "WEE4T4", material_charge: "WEVRFRT4", status_part: "Masspro", qty: 23, berat_part_snapshot: 3.2, berat_total_part: 73.6, tanggal_masuk: "2026-09-23", keterangan: "Material trial QC", process_type: "", diinput_oleh: "", qr_code: "", status_proses: "Process", created_at: "2026-09-23T00:00:00Z", updated_at: "2026-09-23T00:00:00Z" },
    ];
    localStorage.setItem("ht_materials", JSON.stringify(materials));
    const productions = [
      { id: 2001, material_id: 1001, incoming_id: 1001, tracking_id: 5001, status: "Finish", production_status: "FINISH", start_scan_at: "2024-01-11T20:15:32", start_scan_by: "Operator A", visual_check_result: "OK", visual_check_note: "", machine_start_at: "2024-01-11T20:25:10", machine_start_by: "Operator A", finish_scan_at: "2024-01-11T22:45:32", finish_scan_by: "Operator A", process_result: "OK", process_ng_note: "", machine_finish_at: "2024-01-11T22:50:10", machine_finish_by: "Operator A", tanggal_proses: "2024-01-11", jenis_treatment: "Quenching & Tempering", created_at: "2024-01-11T00:00:00Z", updated_at: "2024-01-11T00:00:00Z" },
      { id: 2002, material_id: 1002, incoming_id: 1002, tracking_id: "", status: "Process", production_status: "PROCESS", start_scan_at: "", start_scan_by: "", visual_check_result: "", visual_check_note: "", machine_start_at: "", machine_start_by: "", finish_scan_at: "", finish_scan_by: "", process_result: "", process_ng_note: "", machine_finish_at: "", machine_finish_by: "", tanggal_proses: "2024-01-12", jenis_treatment: "Carburizing", created_at: "2024-01-12T00:00:00Z", updated_at: "2024-01-12T00:00:00Z" },
      { id: 2003, material_id: 1003, incoming_id: 1003, tracking_id: 5002, status: "Finish", production_status: "FINISH", start_scan_at: "2024-01-13T08:00:00", start_scan_by: "Operator B", visual_check_result: "OK", visual_check_note: "", machine_start_at: "2024-01-13T08:10:00", machine_start_by: "Operator B", finish_scan_at: "2024-01-13T17:00:00", finish_scan_by: "Operator B", process_result: "OK", process_ng_note: "", machine_finish_at: "2024-01-13T17:05:00", machine_finish_by: "Operator B", tanggal_proses: "2024-01-13", jenis_treatment: "Normalizing", created_at: "2024-01-13T00:00:00Z", updated_at: "2024-01-13T00:00:00Z" },
      { id: 2004, material_id: 1004, incoming_id: 1004, tracking_id: "", status: "Waiting", production_status: "WAITING", start_scan_at: "", start_scan_by: "", visual_check_result: "", visual_check_note: "", machine_start_at: "", machine_start_by: "", finish_scan_at: "", finish_scan_by: "", process_result: "", process_ng_note: "", machine_finish_at: "", machine_finish_by: "", tanggal_proses: "", jenis_treatment: "", created_at: "2024-01-13T00:00:00Z", updated_at: "2024-01-13T00:00:00Z" },
      { id: 2005, material_id: 1006, incoming_id: 1006, tracking_id: 5003, status: "Process", production_status: "PROCESS", start_scan_at: "2026-09-23T10:00:00", start_scan_by: "Operator C", visual_check_result: "", visual_check_note: "", machine_start_at: "2026-09-23T10:30:00", machine_start_by: "Operator C", finish_scan_at: "", finish_scan_by: "", process_result: "", process_ng_note: "", machine_finish_at: "", machine_finish_by: "", tanggal_proses: "2026-09-23", jenis_treatment: "Quenching & Tempering", created_at: "2026-09-23T00:00:00Z", updated_at: "2026-09-23T00:00:00Z" },
    ];
    localStorage.setItem("ht_productions", JSON.stringify(productions));
    const qcs = [
      { id: 3001, production_id: 2001, material_id: 1001, hardness: "58-62 HRC", satuan_hardness: "HRC", hasil: "OK", inspector: "Inspector A", tanggal_inspector: "2024-01-12", catatan: "QC OK, hardness sesuai standar", user_id: 1, remarks: "", created_at: "2024-01-12T00:00:00Z", updated_at: "2024-01-12T00:00:00Z" },
      { id: 3002, production_id: 2003, material_id: 1003, hardness: "30-35 HRC", satuan_hardness: "HRC", hasil: "OK", inspector: "Inspector B", tanggal_inspector: "2024-01-14", catatan: "QC OK", user_id: 1, remarks: "", created_at: "2024-01-14T00:00:00Z", updated_at: "2024-01-14T00:00:00Z" },
      { id: 3003, production_id: 2005, material_id: 1006, hardness: "", satuan_hardness: "HRC", hasil: "", inspector: "", tanggal_inspector: "", catatan: "", remarks: "", created_at: "2026-09-23T00:00:00Z", updated_at: "2026-09-23T00:00:00Z" },
    ];
    localStorage.setItem("ht_qcs", JSON.stringify(qcs));
    const tracking = [
      { id: 5001, material_id: 1001, production_id: 2001, delivery_id: 4001, remarks: "Material selesai & dikirim", created_at: "2024-01-15T00:00:00Z", updated_at: "2024-01-15T00:00:00Z" },
      { id: 5002, material_id: 1003, production_id: 2003, delivery_id: "", remarks: "Menunggu delivery", created_at: "2024-01-14T00:00:00Z", updated_at: "2024-01-14T00:00:00Z" },
      { id: 5003, material_id: 1006, production_id: 2005, delivery_id: "", remarks: "Proses berjalan", created_at: "2026-09-23T00:00:00Z", updated_at: "2026-09-23T00:00:00Z" },
    ];
